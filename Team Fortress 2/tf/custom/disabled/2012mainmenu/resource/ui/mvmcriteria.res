"Resource/UI/MvMCriteria.res"
{
	...
	"MvMPracticeGroupBox"
	{
		...
		"NoMannUpImage"		//CANNOT REMOVE OR GAME CRASHES JUST MAKE INVISIBLE AND DISABLE
		{
			"ControlName"	"ImagePanel"
		...
		"NoMannUpTitleLabel"	//CANNOT REMOVE OR GAME CRASHES JUST MAKE INVISIBLE AND DISABLE
		{
			"ControlName"	"Label"
		...
		"NoMannUpDescriptionLabel"	//CANNOT REMOVE OR GAME CRASHES JUST MAKE INVISIBLE AND DISABLE
		{
			"ControlName"	"Label"
		...
		"MannUpNowButton"	//CANNOT REMOVE OR GAME CRASHES JUST MAKE INVISIBLE AND DISABLE
		{
		...
		"CommunityTourImage1"
		{
			...
			"enabled"		"1"
			"mouseinputenabled" "0"
			"image"			"../vgui/replay/thumbnails/community_mvm_loot1"
			"scaleImage"	"1"
		}
		...
		"CommunityTourImage2"
		{
			...
			"enabled"		"1"
			"mouseinputenabled" "0"
			"image"			"../vgui/replay/thumbnails/community_mvm_loot2"
			"scaleImage"	"1"
		}
		...
		"CommunityTourImage3"
		{
			...
			"enabled"		"1"
			"mouseinputenabled" "0"
			"image"			"../vgui/replay/thumbnails/community_mvm_loot3"
			"scaleImage"	"1"
		}

		"CommunityTourTitleLabel"
		{
			"ControlName"	"Label"
			"fieldName"		"CommunityTourTitleLabel"
			"font"			"HudFontSmallBold"
		...
		"CommunityTourDescriptionLabel"
		{
			"ControlName"	"Label"
			"fieldName"		"CommunityTourDescriptionLabel"
			"font"			"HudFontSmall"
			"labelText"		"Complete community-made missions to earn medals! Donations from events directly support different charities."
			"textAlignment"	"north-west"
			"wrap"			"1"
			"xpos"			"10"
			"ypos"			"33"
		...
		"PotatoTFButton"
		{
			...
			"dulltext"		"0"
			"brighttext"	"0"
			"command" "url http://potato.tf/"
			"sound_depressed"	"UI/buttonclick.wav"
			"sound_released"	"UI/buttonclickrelease.wav"
			"image_default"		"../vgui/replay/thumbnails/glyph_potato"
			"image_armed"		"../vgui/replay/thumbnails/glyph_potato_armed"
		...
		"MoonlightTFButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"../vgui/replay/thumbnails/glyph_moonlight"
				"scaleImage"	"1"
			}
		}
		
		"CommunityTourOpeninBrowserLabel"
		{
			"ControlName"	"Label"
			"fieldName"		"CommunityTourDescriptionLabel"
			"font"			"MMenuPlayListDesc"
			"labelText"		"(Click a link to open the page in your browser.)"
			"textAlignment"	"center"
			"wrap"			"0"
			"xpos"			"23"
			"ypos"			"105+1"
